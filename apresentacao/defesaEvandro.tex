...
\tikzstyle{cloud} = [draw, ellipse,fill=red!20, node distance=3cm,
    minimum height=1.5em, text width=5em, text centered]
...
\begin{tikzpicture}[node distance = 2cm, auto]
    % Place nodes
    \node [block] (init) {Faz cluster de tempestade elétrica};
    \node [cloud, left of=init] (1B01c4) {VIRS (1B01) canal 4};
    \node [cloud, right of=init] (LISfl) {LIS flash};
    \node [cloud, below of=init] (PR) {PR (2A25): Z$_c$, rain type (2A23), geolocation}; 
