...
Por exemplo na região do Panamá, Colômbia e Equador, entre 10N-0S e 70W-80W, o nível H para a figura \ref{ftacfadwith} é de 4,0 km e o CFAD possui contornos de probabilidade até 16 km de altitude. Na figura \ref{ftcfadwith}, H é igual a 4,2 km e os níveis de contorno param em 15 km. Mesmo a precipitação com raios dos extremos de FTA possuir o maior número que ocorrência de $Z_c$ 200 metros 

A precipitação tridimensional observado nos núcleos de raios, explicitada nos contorno dos CFADs da figura \ref{ftacfadwith}, referente ao índice FTA, mostram valores de refletividade entre 1-3 dBZ  maiores do que na figura \ref{ftcfadwith}, referente ao índice FT, principalmente quando observa-se os contornos de probabilidade de $Z_c$ acima de 5 km de altitude. 

Para a precipitação entre 1-2 km de altitude os valores são mais semelhantes entre as tempestades elétricas selecionadas por FTA e FT. Porém, para FTA (figura \ref{ftacfadwith}) há um estreitamento da região de contorno com os maiores valores de probabilidade associada a chuva na superfície, entre 3-5\%. Entre 20S-40S e 40-70W, o estreitamente é maior do que as demais regiões mostrando que as chuvas possuem maior probabilidade de estarem associadas com valores de 45 dBZ em \ref{ftacfadwith}.      
...
Os valores mais elevados de refletividade estiveram na figura \ref{ftacfadwith} entre 20S-40S e 40W-70W, sobre a Bacia do Rio da Prata, que abrange o Sul do Brasil, Paraguai, Uruguai e Argentina. 
