...
\begin{figure}[!ht]
  ...
  \caption{Densidade de probabilidade de extensão em área.}
  \label{size}  
\end{figure}
...
\begin{figure}[!hb]
  ...
  \caption{Densidade de probabilidade de temperatura de brilho em infravermelho do topo das nuvens.}
  \label{tb}
\end{figure}
...
\begin{figure}[!ht]
  ...
  \caption{Dispersão entre a áreas das tempestades elétricas e os valores de FTA e FT.}
  \label{areaFTAFTA}  
\end{figure}
...
\begin{figure}[!hb]
  ...
  \caption{Dispersão entre o volume de chuva das tempestades elétricas e os valores de FTA e FT.}
  \label{areaFTAFT}
\end{figure}
