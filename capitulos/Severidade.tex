...
Na mediana da amostragem de FTA observa-se 2,3 $\times$ 10$^{-4}$ raios min$^{-1}$ km$^{-2}$, e na mediana da amostragem de FT 3,4 raios min$^{-1}$. Observe que o maior número de tempestades elétricas possuem os menores valores FTA e FT. Observe que na curva referente a distribuição cumulativa de FT na figura \ref{cdfFTAFT}, que o primeiro degrau da curva corresponde a 28,9\% da amostragem das {94~733} tempestades elétricas do TRMM. O primeiro degrau da distribuição cumulativa de FTA (figura \ref{cdfFTAFT}) corresponde a 9,2\% de {94~733}. 
...
O grupo das tempestades elétricas com FTA extremo, possuíram valores entre {29,3--1258,7 $\times$ 10$^{-4}$} raios por minuto por quilômetro quadrado ([min$^{-1}$] [km$^{-2}$]), enquanto as tempestades elétricas com extremos de FT possuíram valores entre {47,2--1283,6} raios por minuto ([min$^{-1}$]). Note que, os sistemas severos classificados pelo índice FT, correspondem as taxas de raios min$^{-1}$ das PFs de categoria três, quatro e cinco, as quais possuíram taxa de raios entre 30,9--1351 raios min$^{-1}$, que totalizaram 5727 PFs observadas sobre o globo em 3 anos de dados do TRMM \cite{cecil2005}. Neste trabalho de pesquisa, que considera apenas a região da AS, porém 13 anos de dados do TRMM, os extremos de FT ({47,2--1283,6} raios min$^{-1}$) representam um total de 9473 tempestades elétricas do TRMM.      
...
Nas figuras \ref{topFTA} e \ref{topFT} ilustram as medidas do TRMM para as 4 tempestades elétricas com FTA e FT mais intensos e que possuíram pelo menos 50\% da sua área dentro da visada do PR. 
