...
Note que no canto superior direito de cada CFAD temos alguns valores estatísticos que representam: (\%)  a porcentagem de perfis convectivos, estratiformes e outros, respectivamente; (P) o número de perfis do PR computados; (L) o número de ocorrência de $Z_c$ no nível de altitude de máxima ocorrência; (H) o nível de altitude, em quilômetros, aonde ocorreu o máximo de ocorrências de $Z_c$; (N) o número de tempestades elétricas no grupo dos extremos contidas na região de 10$^{\circ}$ $\times$ 10$^{\circ}$.
...
\simbolo{name={N},description={Nos diagramas, CFAD, CCFAD, CFTD e CCFTD, representam: o número de tempestades elétricas no grupo dos extremos contida na região de 10$^{\circ}$ $\times$ 10$^{\circ}$}}
