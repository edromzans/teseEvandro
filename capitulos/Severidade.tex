...
Portanto, a partir da $f_{cdf}(x,y)$ que define os diagramas CCFTD e CFTD conforme é descrito em \ref{metodologiaPrec3D},  extraí-se as linhas de contorno do CCFTD referentes as probabilidades cumulativas de 30\%, 50\%, 70\% e 95\%. Desta forma, obteve-se quatro funções 
\begin{equation}
f(x)=y ,
\end{equation} 
...
Mesmo considerando hipoteticamente que entre 10-0S e 70-60W, as tempestades elétricas com extremos de FT possuíram maior probabilidade de centros de cargas principal positivo, esse fato pode não determinar que as tempestades elétricas com índice FT extremo sejam positivas\footnote{Tempestades elétricas com 25\% dos raios nuvem-solo positivos \cite{carey2007}}. \citeonline{fernandes2005,fernandes2006} apontam que no ambiente amazônico seco e poluído, as nuvens podem ter altura da base mais elevadas e mesmo que os processos de crescimento de hidrometeoros ocorram em regiões de maior altitude e consequentemente de menor temperatura, como sugerem os extremos de FTA em relação aos extremos de FT, o centro de carga principal fica mais distante da superfície, aumentando a razão entre os raios intranuvens e nuvem-solo e favorecendo as descargas positivas a partir do centro de carga positivo na base da nuvem, que de acordo com o modelo do tripolo eletrostático proposto em \citeonline{williams1989}, fica mais próximo do solo do que o centro de cargas negativo principal.
...
Nos sistemas com FT extremos, o crescimento do \textit{graupel} ocorreu em temperaturas superiores a -10\textsuperscript{o}C, ambiente  supostamente mais carregado de gotículas de água superesfriadas e neve molhada do que de cristais de gelo, sugerindo processo de crescimento de granizo esponjoso, ou seja, granizo molhado, processos que não são eficientes para a eletrização \cite{jayaratne1983}. 

Portanto, mesmo que os extremos de FT representem sistemas com maior número de raios, a maior densidade superficial de raios, então maiores valores de FTA, correspondem a processos de eletrificação mais eficientes do que um sistema de tempestades enorme e com muitos raios.
...
\subfloat[Derivadas das linhas de contorno dos CCFTDs.]{\includegraphics[height=9cm]{img/precipitacao3d/deriv_ccftd/deriv_contornos_cdf_3_3}}
