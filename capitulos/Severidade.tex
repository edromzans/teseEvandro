...
Então, para a região central da Bacia do Rio Amazonas, entre 10-0S e 70-60W, extraí-se as linhas de contorno do CCFTD referentes as probabilidades acumulativas de 30\%, 50\%, 70\% e 95\%. Desta forma obtemos quatro funções $f(x,y)$, em que x correspondem aos valores de $Z_c$ e y o perfil atmosférico de temperatura.
...
calculada a derivada das respectivas linhas de contorno. Desta forma, avalia-se a taxa de aumento ou decrescimento de $Z_c$ por temperatura (dBZ/°C), a cada nível de temperatura nos diferentes quartis do CCFTD dos extremos de FTA,  figura \ref{ccftd_fta_com},  e dos extremos de FT, figura \ref{ccftd_ft_com}.
