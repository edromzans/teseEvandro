...
Fazer a identificação de sistemas que possuem atividade elétrica, ou seja, tempestades elétricas, apenas sobre a América do Sul a partir das observações orbitais do satélite TRMM, mais especificamente do sensor de raios LIS, do radiômetro \textit{Visible and InfraRed Scanner} (VIRS) e do radar PR, desde o início de 1998 até o final de 2011, totalizando 14 anos de dados e desta forma criar um banco de dados de tempestades elétricas do TRMM.

Com este subconjunto de dados do TRMM, determinar a sazonalidade, o ciclo diurno e ciclo anual das tempestades elétricas. Apesar de \citeonline{zipser2006} mostrarem o ciclo diurno e anual das PFs para diferentes localidades do globo, bem com em \citeonline{raio} o ciclo diurno e anual de ocorrência de raios, carece na literatura estudos a respeito do ciclo diurno e ciclo anual focado nas tempestades elétricas da região da AS, de modo a determinar o marco das tempestades elétricas na América do Sul.

Mesmo que trabalhos como em \cite{rachel,cecil,cristian} mostrem os mapas de densidade geográfica de raios global, inclusive sobre a região da AS, não é possível saber quantas tempestades elétricas que são responsáveis pela densidade de raios de cada localidade da AS. Portanto, nesta pesquisa, além dos mapas de densidade geográfica de raios, cria-se os mapas de densidade geográfica de tempestades elétricas e de raios por tempestades elétricas buscando evidenciar regiões e estações do ano em que as tempestades elétricas são mais eficientes na produção de raios para a região América do Sul.

% de tempestades elétricas e de raios por tempestades elétricas buscando evidenciar regiões e estações do ano em que as tempestades elétricas possuem processo de eletrificação mais eficientes sobre a América do Sul.

Determinar a intensidade convectiva das tempestades elétricas com base nas observações de raios do LIS e aspectos morfológicos como: dimensões relacionadas a extensão dos sistemas e a estrutura tridimensional da precipitação observada pelo PR. Conforme \citeonline{macgorman1989,carey1998,gatlin2010, schultz2011,williams1999} e \citeonline{cecil2005} sabe-se que a taxa de raios no tempo (raios [min$^{-1}$]) de uma tempestade elétrica pode indicar condições de tempo severo, porém, estes trabalhos não verificam se as condições de tempo severo estão relacionadas com tempestades elétricas de elevadas taxas de raios no tempo por área (raios [min$^{-1}$] [km$^{-2}$]), as quais podem produzir baixo número de raios (5--10 raios min$^{-1}$), mas próximos no tempo e no espaço. Portanto com base na estrutura tridimensional da precipitação, é avaliado quais as tempestades elétricas que podem representar maior intensidade convectiva. As com elevados números de raios durante os $/simeq$90 segundos que o TRMM as observa ou as com elevadas densidades espaciais de raios?
