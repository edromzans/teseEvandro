...
\label{parametroTam} 
\end{equation}
em que $R_{h}$ é o raio do hidrometeoro e portanto, $2\pi R_{h}$ a área da seção transversal do hidrometeoro precipitável na atmosfera e ($\lambda$) o comprimento de onda emitido pelo radar, quando $\alpha$ $<<$ 1, o espalhamento da radiação eletromagnética pelas partículas será do tipo Rayleigh. Neste caso, a seção transversal de retroespalhamento $\sigma$ pode ser escrita como 
\begin{equation}
