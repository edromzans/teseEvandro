...
As teorias de eletrificação das
...
\index{Processo!colisional indutivo}
...
\begin{figure}[htp]
   \centering
   \subfloat[Processo de indução elétrica.]{\includegraphics[height=9cm]{img/ilustracoes/indutivopdf-a} \label{fig:ind-a}}  
   \subfloat[Colisão e eletrização por contato.]{\includegraphics[height=9cm]{img/ilustracoes/indutivopdf-b} \label{fig:ind-b}}
