...
A distribuição geográfica da densidade de tempestades elétricas e também de raios sobre a AS busca mostrar as regiões de maior e menor ocorrência de raios e de tempestades elétricas e também identificar os locais e períodos do ano em que as tempestades elétricas produzem mais raios por número de tempestades, i.e., apresentam processos de eletrificação mais eficazes. 
