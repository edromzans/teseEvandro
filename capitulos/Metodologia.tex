...
Foram investigadas 68,230 orbitas do TRMM, juntamente com dados em 17 níveis de pressão das reanálises II do NCEP. \sigla{name={NCEP},description={\textit{National Centers for Environmental Prediction}}}
...
%(ftp://disc2.nascom.nasa.gov/ftp/data/s4pa). 
...
%O aumento de potência recebida no radar na camada de derretimento pode ser intensificada na presença de flocos de neve, que ao derreter, desenvolvem uma película de água líquida ao seu redor, o que aumenta o espalhamento radiativo das micro-ondas enviadas pelo radar.%, causando a banda brilhante.
...
%Neste trabalho buscamos associar a intensidade convectiva com a intensidade dos processos de eletrificação.
% com perfis de chuva que mostram aumentos abruptos nos valores de $Z_c$ em regiões acima da camada de derretimento, que indicam intensificação da agregação, juntamente com uma espessa camada de derretimento. 
%Este poderá ser um ambiente eficiente na produção de descargas elétricas.

%ocorre em um caminho de temperatura muito maior do que na precipitação estratiforme.
