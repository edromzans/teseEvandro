...
\begin{figure}[!ht]
  \centering{
  \subfloat[Tempo de visada do LIS (0.25$^{\circ}$  $\times$ 0.25$^{\circ}$).]{{\includegraphics[height=10.65cm]{img/grids/vt_trmm}} \label{lisVT}}\\
  \subfloat[Número de passagens do VIRS (0.25$^{\circ}$  $\times$ 0.25$^{\circ}$).]{{\includegraphics[height=10.65cm]{img/grids/passagens_virs_1998-2011}} \label{VirsVT}}
  }
...
\begin{figure}[!ht]
  \centering{
  \subfloat[Acumulado de raios observados pelo LIS (0,25°).]{{\includegraphics[height=10.65cm]{img/grids/densEspacial_19982011acumuladoTaxaFlashPolyfill}} \label{taxatotalraios}}\\
  \subfloat[Acumulado das áreas de tempestade elétrica (0,25°).]{{\includegraphics[height=10.65cm]{img/grids/densEspacial19982011acumuladoTempestadesPolyfill}} \label{taxaTotalTe}}
  }
