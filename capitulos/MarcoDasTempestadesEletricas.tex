...
Na primavera austral (SON), é quando o continente Sul-americano recebe a maior incidência de raios. Apesar da estação de tempestades elétricas na região Sul da AS estar definida predominantemente em DJF, e ao Norte e Noroeste da AS predominantemente em SON, ao avaliar a densidade de raios, tanto sobre a Bacia do Prata quanto sobre a Bacia Amazônica, as maiores densidades de raios ocorrem em SON. Os valores de densidade de raios no mapa da figura \ref{txSON} sobre ambas as bacias hidrográficas (11.4--40.0 raios ano$^{-1}$ km$^{-2}$) indicam que as tempestades elétricas de primavera produzem entre 1 e 3 raios mes${^-1}$ km$^{-2}$. A maior densidade de raios sazonal foi observada sobre a região do Lago Maracaibo durante SON em que as tempestades elétricas produzem 8 raios mes${^-1}$ km$^{-2}$ (90.7 raios ano$^{-1}$ km$^{-2}$).
