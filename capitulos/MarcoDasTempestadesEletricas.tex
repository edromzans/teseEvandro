...
Observa-se que a estação de tempestades elétricas na América do Sul se configura entre outubro e março e possui dois picos: janeiro e outubro. O maior valor de probabilidade foi de 10.9\%  no mês de outubro. Entre outubro e março foram observadas 60.2\% das tempestades elétricas. % Entre janeiro e março as tempestades elétricas tiveram probabilidade de 0.3\% menor do que no início da estação, em outubro.   
